(function (a) {
            ...
            methods: {
                    ...
                    return (
                        a(s).bind("submit", function (e) {
                            ...
                            o.trigger("submit.validation").trigger("validationLostFocus.validation"),
                                o.each(function (e, t) {
                                    var i = a(t),
                                        o = i.parents(".form-group, .checkbox").first();
                                    o.hasClass("warning") && (o.removeClass("warning").addClass("error"), n++);
                                }),
                                o.trigger("validationLostFocus.validation"),
                                n
                                    ? (t.options.preventSubmit && e.preventDefault(), i.addClass("error"), a.isFunction(t.options.submitError) && t.options.submitError(i, e, o.jqBootstrapValidation("collectErrors", !0)))
                                    : (i.removeClass("error"), a.isFunction(t.options.submitSuccess) && t.options.submitSuccess(i, e));
                        }),
                        this.each(function () {
                            var e = a(this),
                                n = e.parents(".form-group, .checkbox").first(),
                                l = n.find(".help-block").first(),
                                s = e.parents("form").first(),
                                d = [];
                            if ((!l.length && t.options.autoAdd && t.options.autoAdd.helpBlocks && ((l = a('<div class="help-block" />')), n.append(l), i.push(l[0])), t.options.sniffHtml)) {
                                var c = "";
                                if (
                                ...
                                void 0 !== e.attr("maxlength") &&
                                    ...
                                    (void 0 === e.attr("required") && void 0 === e.attr("aria-required")) ||
                                        ((c = t.builtInValidators.required.message), e.data("validationRequiredMessage") && (c = e.data("validationRequiredMessage")), e.data("validationRequiredMessage", c)),
                                    void 0 !== e.attr("type") &&
                                        "number" === e.attr("type").toLowerCase() &&
                                        ((c = t.builtInValidators.number.message), e.data("validationNumberMessage") && (c = e.data("validationNumberMessage")), e.data("validationNumberMessage", c)),
                                    void 0 !== e.attr("type") &&
                            ...
                            void 0 !== e.data("validation") && (d = e.data("validation").split(",")),
                                a.each(e.data(), function (a, e) {
                            ...
                            do {
                                a.each(d, function (a, e) {
                                    ...
                                    (d = a.unique(d)),
                                    (g = []),
                                    a.each(m, function (i, n) {
                                        if (void 0 !== e.data("validation" + n + "Shortcut"))
                                            a.each(e.data("validation" + n + "Shortcut").split(","), function (a, e) {
                                                g.push(e);
                                            });
                            ...
                            a.each(d, function (i, n) {
                                var r = e.data("validation" + n + "Message"),
                                    l = void 0 !== r,
                                    s = !1;
                                if (
                                    ((r = r || "'" + n + "' validation failed <!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message -->"),
                                    a.each(t.validatorTypes, function (t, i) {
                                        void 0 === h[t] && (h[t] = []), s || void 0 === e.data("validation" + n + o(i.name)) || (h[t].push(a.extend(!0, { name: o(i.name), message: r }, i.init(e, n))), (s = !0));
                                    }),
                                    !s && t.builtInValidators[n.toLowerCase()])
                                ) {
                                    ...
                                    "shortcut" === c
                                        ? (s = !0)
                                        : a.each(t.validatorTypes, function (t, i) {
                                              void 0 === h[t] && (h[t] = []), s || c !== t.toLowerCase() || (e.data("validation" + n + o(i.name), d[i.name.toLowerCase()]), h[c].push(a.extend(d, i.init(e, n))), (s = !0));
                                          });
                                }
                                ...
                                n.data("original-classes", n.data("original-clases") ? n.data("original-classes") : n.attr("class")),
                                e.data("original-aria-invalid", e.data("original-aria-invalid") ? e.data("original-aria-invalid") : e.attr("aria-invalid")),
                                e.bind("validation.validation", function (i, n) {
                                    var o = r(e),
                                        l = [];
                                    return (
                                        a.each(h, function (i, r) {
                                            (o || o.length || (n && n.includeEmpty) || (t.validatorTypes[i].blockSubmit && n && n.submitting)) &&
                                                a.each(r, function (a, n) {
                                                    t.validatorTypes[i].validate(e, o, n) && l.push(n.message);
                                                });
                                        }),
                                        l
                                    );
                                ...
                                e.bind(["keyup", "focus", "blur", "click", "keydown", "keypress", "change"].join(".validation ") + ".validation", function (i, o) {
                                    ...
                                    n.find("input,textarea,select").each(function (t, i) {
                                        var n = c.length;
                                        if (
                                            (a.each(a(i).triggerHandler("validation.validation", o), function (a, e) {
                                                c.push(e);
                                            }),
                                            c.length > n)
                                        )
                                        ...
                                        (c = a.unique(c.sort())),
                                        c.length
                                            ? (n.removeClass("success error").addClass("warning"),
                                              t.options.semanticallyStrict && 1 === c.length
                                                  ? l.html(c[0] + (t.options.prependExistingHelpBlock ? l.data("original-contents") : ""))
                                                  : l.html('<ul class="list-unstyled alert alert-warning" role="alert"><li>' + c.join("</li><li>") + "</li></ul>" + (t.options.prependExistingHelpBlock ? l.data("original-contents") : "")))
                                            : (n.removeClass("warning error success"), d.length > 0 && n.addClass("success"), l.html(l.data("original-contents"))),
                                        "blur" === i.type && n.removeClass("success");
                                }),
                ...
                destroy: function () {
                    return this.each(function () {
                        var e = a(this),
                            t = e.parents(".form-group, .checkbox").first(),
                        ...
                        if (!0 === i.lastFinished) {
                            ...
                            t(i.callback, window, a, e, function (a) {
                                n.lastValue === a.value &&
                                    ...
                                    (n.lastFinished = !0),
                                    o.data("validation" + n.validatorName + "Message", n.message),
                                    setTimeout(function () {
    ...
    (a.fn.jqBootstrapValidation = function (e) {
        return n.methods[e]
            ? n.methods[e].apply(this, Array.prototype.slice.call(arguments, 1))
            : "object" != typeof e && e
            ? (a.error("Method " + e + " does not exist on jQuery.jqBootstrapValidation"), null)
            : n.methods.init.apply(this, arguments);
    }),
