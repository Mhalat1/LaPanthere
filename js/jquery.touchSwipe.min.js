!(function (e) {
    ...
    function t(n, t) {
            ...
            if (We !== x && We !== S && !ae()) {
                ...
                if (
                    ...
                    if (((Ne = Se(o.start, o.end)), (He = Se(o.last, o.end)), C(e, He), (je = me(o.start, o.end)), (_e = Te()), de(Ne, je), (r = j(n, We)), !t.triggerOnTouchEnd || t.triggerOnTouchLeave)) {
                        ...
                        !t.triggerOnTouchEnd && u ? (We = U(m)) : t.triggerOnTouchLeave && !u && (We = U(x)), (We != S && We != x) || j(n, We);
                    }
                } else (We = S), j(n, We);
                !1 === r && ((We = S), j(n, We));
            }
        ...
        function R(e) {
            ...
            return (
                ...
                _() || !H()
                    ? ((We = S), j(n, We))
                    : t.triggerOnTouchEnd || (!1 === t.triggerOnTouchEnd && We === m)
                    ? (!1 !== t.preventDefaultEvents && !1 !== e.cancelable && e.preventDefault(), (We = x), j(n, We))
        ...
        function I() {
            Ve.unbind(Re, r), Ve.unbind(Ue, k), Ve.unbind(ke, L), Ve.unbind(Ae, R), Ie && Ve.unbind(Ie, A), se(!1);
        }
        function U(e) {
            var n = e,
                r = Q(),
                i = H(),
                l = _();
            return !r || l ? (n = S) : !i || e != m || (t.triggerOnTouchEnd && !t.triggerOnTouchLeave) ? !i && e == x && t.triggerOnTouchLeave && (n = S) : (n = x), n;
        }
        function j(e, n) {
            var t,
                r = e.touches;
            return (
                (z() || W()) && (t = N(e, n, f)),
                (Y() || X()) && !1 !== t && (t = N(e, n, h)),
                ie() && !1 !== t ? (t = N(e, n, g)) : le() && !1 !== t ? (t = N(e, n, v)) : re() && !1 !== t && (t = N(e, n, d)),
                n === S && k(e),
                n === x && ((r && r.length) || k(e)),
                t
            );
        ...
        function N(n, r, s) {
            var p;
            if (s == f) {
                if ((Ve.trigger("swipeStatus", [r, Ne || null, je || 0, _e || 0, ze, Ge, He]), t.swipeStatus && ((p = t.swipeStatus.call(Ve, n, r, Ne || null, je || 0, _e || 0, ze, Ge, He)), !1 === p))) return !1;
                if (r == x && V()) {
                    if ((clearTimeout(en), clearTimeout(nn), Ve.trigger("swipe", [Ne, je, _e, ze, Ge, He]), t.swipe && ((p = t.swipe.call(Ve, n, Ne, je, _e, ze, Ge, He)), !1 === p))) return !1;
                    switch (Ne) {
                        case i:
                            Ve.trigger("swipeLeft", [Ne, je, _e, ze, Ge, He]), t.swipeLeft && (p = t.swipeLeft.call(Ve, n, Ne, je, _e, ze, Ge, He));
                            break;
                        case l:
                            Ve.trigger("swipeRight", [Ne, je, _e, ze, Ge, He]), t.swipeRight && (p = t.swipeRight.call(Ve, n, Ne, je, _e, ze, Ge, He));
                            break;
                        case o:
                            Ve.trigger("swipeUp", [Ne, je, _e, ze, Ge, He]), t.swipeUp && (p = t.swipeUp.call(Ve, n, Ne, je, _e, ze, Ge, He));
                            break;
                        case u:
                            Ve.trigger("swipeDown", [Ne, je, _e, ze, Ge, He]), t.swipeDown && (p = t.swipeDown.call(Ve, n, Ne, je, _e, ze, Ge, He));
                    }
                }
            }
            if (s == h) {
                if ((Ve.trigger("pinchStatus", [r, Xe || null, Fe || 0, _e || 0, ze, Ce, Ge]), t.pinchStatus && ((p = t.pinchStatus.call(Ve, n, r, Xe || null, Fe || 0, _e || 0, ze, Ce, Ge)), !1 === p))) return !1;
                if (r == x && F())
                    switch (Xe) {
                        case a:
                            Ve.trigger("pinchIn", [Xe || null, Fe || 0, _e || 0, ze, Ce, Ge]), t.pinchIn && (p = t.pinchIn.call(Ve, n, Xe || null, Fe || 0, _e || 0, ze, Ce, Ge));
                            break;
                        case c:
                            Ve.trigger("pinchOut", [Xe || null, Fe || 0, _e || 0, ze, Ce, Ge]), t.pinchOut && (p = t.pinchOut.call(Ve, n, Xe || null, Fe || 0, _e || 0, ze, Ce, Ge));
                    }
            }
            return (
                s == d
                    ? (r !== S && r !== x) ||
                      ...
                      J() && !ee()
                          ? (($e = Oe()),
                            (en = setTimeout(
                                e.proxy(function () {
                                    ($e = null), Ve.trigger("tap", [n.target]), t.tap && (p = t.tap.call(Ve, n, n.target));
                                }, this),
                                t.doubleTapThreshold
                            )))
                          : (($e = null), Ve.trigger("tap", [n.target]), t.tap && (p = t.tap.call(Ve, n, n.target))))
                    : s == g
                    ? (r !== S && r !== x) || (clearTimeout(en), clearTimeout(nn), ($e = null), Ve.trigger("doubletap", [n.target]), t.doubleTap && (p = t.doubleTap.call(Ve, n, n.target)))
                    : s == v && ((r !== S && r !== x) || (clearTimeout(en), ($e = null), Ve.trigger("longtap", [n.target]), t.longTap && (p = t.longTap.call(Ve, n, n.target)))),
                p
            );
        }
        function H() {
        ...
        function ce() {
            return !(!0 !== Ve.data(P + "_intouch"));
        }
        function se(e) {
            Ve && (!0 === e ? (Ve.bind(ke, L), Ve.bind(Ae, R), Ie && Ve.bind(Ie, A)) : (Ve.unbind(ke, L, !1), Ve.unbind(Ae, R, !1), Ie && Ve.unbind(Ie, A, !1)), Ve.data(P + "_intouch", !0 === e));
        }
        function pe(e, n) {
        ...
        function ve() {
            var e = {};
            return (e[i] = we(i)), (e[l] = we(l)), (e[o] = we(o)), (e[u] = we(u)), e;
        }
        function we(e) {
        ...
        function Me(n) {
            n = e(n);
            var t = n.offset(),
                r = { left: t.left, right: t.left + n.outerWidth(), top: t.top, bottom: t.top + n.outerHeight() };
            return r;
        }
        function De(e, n) {
        ...
        t = e.extend({}, t);
        var Le = O || D || !t.fallbackToMouseEvents,
            Re = Le ? (D ? (M ? "MSPointerDown" : "pointerdown") : "touchstart") : "mousedown",
            ...
            nn = null;
        try {
            Ve.bind(Re, r), Ve.bind(Ue, k);
        } catch (n) {
            e.error("events not supported " + Re + "," + Ue + " on jQuery.swipe");
        }
        (this.enable = function () {
            return this.disable(), Ve.bind(Re, r), Ve.bind(Ue, k), Ve;
        }),
            (this.disable = function () {
                return I(), Ve;
            }),
            (this.destroy = function () {
                I(), Ve.data(P, null), (Ve = null);
            }),
    ...
    (e.fn.swipe = function (t) {
        ...
        (e.fn.swipe.phases = { PHASE_START: E, PHASE_MOVE: m, PHASE_END: x, PHASE_CANCEL: S }),
        (e.fn.swipe.directions = { LEFT: i, RIGHT: l, UP: o, DOWN: u, IN: a, OUT: c }),
        (e.fn.swipe.pageScroll = { NONE: s, HORIZONTAL: w, VERTICAL: T, AUTO: p }),
