!(function (e, t) {
    ...
    function m(e, t) {
        var n, r, i, o, s, a, u, l;
        if (1 === t.nodeType) {
            if (ve.hasData(e) && ((o = ve.access(e)), (s = ve.set(t, o)), (l = o.events))) for (i in (delete s.handle, (s.events = {}), l)) for (n = 0, r = l[i].length; r > n; n++) ee.event.add(t, i, l[i][n]);
    ...
    function b(e) {
        ...
        return (
            n ||
                ((n = x(e, t)),
                ("none" !== n && n) || ((We = (We || ee("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)), (t = We[0].contentDocument), t.write(), t.close(), (n = x(e, t)), We.detach()),
                ($e[e] = n)),
            n
        );
    }
    function w(e, t, n) {
        ...
        return (
            ...
            n &&
                ("" !== s || ee.contains(e.ownerDocument, e) || (s = ee.style(e, t)),
                Ie.test(s) && Be.test(t) && ((r = a.width), (i = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = r), (a.minWidth = i), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function T(e, t) {
    ...
    function k(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += ee.css(e, n + Te[o], !0, i)),
                r
                    ? ("content" === n && (s -= ee.css(e, "padding" + Te[o], !0, i)), "margin" !== n && (s -= ee.css(e, "border" + Te[o] + "Width", !0, i)))
                    : ((s += ee.css(e, "padding" + Te[o], !0, i)), "padding" !== n && (s += ee.css(e, "border" + Te[o] + "Width", !0, i)));
        return s;
    }
    function E(e, t, n) {
        var r = !0,
        ...
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
            (r = e[s]),
                r.style &&
                    ...
                    (n = r.style.display),
                    t
                        ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ce(r) && (o[s] = ve.access(r, "olddisplay", b(r.nodeName))))
                        : o[s] || ((i = Ce(r)), ((n && "none" !== n) || !i) && ve.set(r, "olddisplay", i ? n : ee.css(r, "display"))));
    ...
    function q(e, t, n) {
        ...
        1 === e.nodeType &&
            ...
            ((n.overflow = [p.overflow, p.overflowX, p.overflowY]), (l = ee.css(e, "display")), "none" === l && (l = b(e.nodeName)), "inline" === l && "none" === ee.css(e, "float") && (p.display = "inline-block")),
        n.overflow &&
            ((p.overflow = "hidden"),
            c.always(function () {
        ...
        if (!ee.isEmptyObject(f))
            for (r in (h ? "hidden" in h && (d = h.hidden) : (h = ve.access(e, "fxshow", {})),
            o && (h.hidden = !d),
            d
                ? ee(e).show()
                : c.done(function () {
            ...
            c.done(function () {
                var t;
                for (t in (ve.remove(e, "fxshow"), f)) ee.style(e, t, f[t]);
            }),
            f))
                (s = L(d ? h[r] : 0, r, c)), r in h || ((h[r] = s.start), d && ((s.end = s.start), (s.start = "width" === r || "height" === r ? 1 : 0)));
    }
    function H(e, t) {
        var n, r, i, o, s;
        for (n in e)
    ...
    function F(e) {
        return function (t, n) {
            ...
            if (ee.isFunction(n)) for (; (r = o[i++]); ) "+" === r[0] ? ((r = r.slice(1) || "*"), (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n);
        };
    }
    function P(e, t, n, r) {
        function i(a) {
                ...
                if (null != (e = arguments[a]))
                    for (t in e)
                        (n = s[t]),
                            (r = e[t]),
                            s !== r &&
                                (l && r && (ee.isPlainObject(r) || (i = ee.isArray(r)))
                                    ? (i ? ((i = !1), (o = n && ee.isArray(n) ? n : [])) : (o = n && ee.isPlainObject(n) ? n : {}), (s[t] = ee.extend(l, o, r)))
                                    : void 0 !== r && (s[t] = r));
            return s;
        }),
        ee.extend({
            ...
            each: function (e, t, r) {
                var i,
                    ...
                    a = n(e);
                if (r) {
                    if (a) for (; s > o && ((i = t.apply(e[o], r)), !1 !== i); o++);
                    else for (o in e) if (((i = t.apply(e[o], r)), !1 === i)) break;
                } else if (a) for (; s > o && ((i = t.call(e[o], o, e[o])), !1 !== i); o++);
    ...
    var ie = (function (e) {
        ...
        function p(e, n) {
            ...
            for (a = e, u = [], l = N.preFilter; a; ) {
                for (s in ((!r || (i = le.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push((o = []))),
                (r = !1),
                (i = ce.exec(a)) && ((r = i.shift()), o.push({ value: r, type: i[0].replace(ue, " ") }), (a = a.slice(r.length))),
                N.filter))
                    !(i = he[s].exec(a)) || (l[s] && !(i = l[s](i))) || ((r = i.shift()), o.push({ value: r, type: s, matches: i }), (a = a.slice(r.length)));
                if (!r) break;
            }
            ...
            for (
                ...
                if ((n = N.relative[e[a].type])) c = [h(g(c), n)];
                    ...
                    if (((n = N.filter[e[a].type].apply(null, e[a].matches)), n[W])) {
                        ...
                        return v(a > 1 && g(c), a > 1 && d(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(ue, "$1"), n, r > a && y(e.slice(a, r)), i > r && y((e = e.slice(r))), i > r && d(e));
                    }
                    c.push(n);
                }
            return g(c);
        ...
        (L = t.setDocument = function (e) {
            ...
            return n !== q && 9 === n.nodeType && n.documentElement
                ? ((q = n),
                  ...
                  (P = []),
                  (F = []),
                  (C.qsa = ve.test(n.querySelectorAll)) &&
                      (i(function (e) {
                          (e.innerHTML = "<select t=''><option selected=''></option></select>"),
                              e.querySelectorAll("[t^='']").length && F.push("[*^$]=" + re + "*(?:''|\"\")"),
                  ...
                  (C.matchesSelector = ve.test((M = H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector))) &&
                      i(function (e) {
                  ...
                  (U = t
                      ? function (e, t) {
                            ...
                            return (
                                ...
                                1 & r || (!C.sortDetached && t.compareDocumentPosition(e) === r)
                                    ? e === n || (e.ownerDocument === $ && R($, e))
                                        ? -1
                                        : t === n || (t.ownerDocument === $ && R($, t))
                                        ? 1
                                        : S
        ...
        (t.matchesSelector = function (e, n) {
            if (((e.ownerDocument || e) !== q && L(e), (n = n.replace(fe, "='$1']")), !(!C.matchesSelector || !O || (P && P.test(n)) || (F && F.test(n)))))
                try {
                    var r = M.call(e, n);
            ...
            preFilter: {
                ...
                PSEUDO: function (e) {
                    ...
                    return he.CHILD.test(e[0])
                        ? null
                        : (e[3] && void 0 !== e[4] ? (e[2] = e[4]) : n && pe.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                },
            },
            filter: {
                TAG: function (e) {
        ...
        return (
            (f.prototype = N.filters = N.pseudos),
            (N.setFilters = new f()),
            ...
            (C.sortStable = W.split("").sort(U).join("") === W),
    ...
    (ee.Callbacks = function (e) {
                    ...
                    return (
                        u &&
                            ee.each(arguments, function (e, t) {
                                for (var n; (n = ee.inArray(t, u, n)) > -1; ) u.splice(n, 1), r && (s >= n && s--, a >= n && a--);
                            }),
                        this
                    );
                },
        ...
        ee.extend({
            ...
            when: function (e) {
                ...
                if (s > 1) for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) o[i] && ee.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --a;
        ...
        ee.extend({
            ...
            ready: function (e) {
                (!0 === e ? --ee.readyWait : ee.isReady) || ((ee.isReady = !0), (!0 !== e && --ee.readyWait > 0) || (de.resolveWith(K, [ee]), ee.fn.trigger && ee(K).trigger("ready").off("ready")));
            },
        }),
        (ee.ready.promise = function (t) {
            return de || ((de = ee.Deferred()), "complete" === K.readyState ? setTimeout(ee.ready) : (K.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1))), de.promise(t);
        }),
        ee.ready.promise();
    var me = (ee.access = function (e, t, n, r, i, o, s) {
        var a = 0,
            u = e.length,
            l = null == n;
        if ("object" === ee.type(n)) for (a in ((i = !0), n)) ee.access(e, t, a, n[a], !0, o, s);
        else if (
            void 0 !== r &&
            ((i = !0),
            ee.isFunction(r) || (s = !0),
        ...
        (a.prototype = {
            ...
            remove: function (e, t) {
                ...
                if (void 0 === t) this.cache[o] = {};
                    ...
                    ee.isArray(t) ? (r = t.concat(t.map(ee.camelCase))) : ((i = ee.camelCase(t)), t in s ? (r = [t, i]) : ((r = i), (r = r in s ? [r] : r.match(he) || []))), (n = r.length);
                    for (; n--; ) delete s[r[n]];
                }
            },
            hasData: function (e) {
    ...
    (ee.event = {
                ...
                for (
                    ...
                    (a = Se.exec(t[l]) || []),
                        ...
                        d &&
                            ...
                            (f = ee.event.special[d] || {}),
                            (c = ee.extend({ type: d, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && ee.expr.match.needsContext.test(i), namespace: h.join(".") }, o)),
                            (p = u[d]) || ((p = u[d] = []), (p.delegateCount = 0), (f.setup && !1 !== f.setup.call(e, r, h, s)) || (e.addEventListener && e.addEventListener(d, s, !1))),
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(he) || [""], l = t.length; l--; )
                    if (((a = Se.exec(t[l]) || []), (d = g = a[1]), (h = (a[2] || "").split(".").sort()), d)) {
                        for (f = ee.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--; )
                            (c = p[o]),
                                (!i && g !== c.origType) ||
                                    (n && n.guid !== c.guid) ||
                        ...
                        s && !p.length && ((f.teardown && !1 !== f.teardown.call(e, h, m.handle)) || ee.removeEvent(e, d, m.handle), delete u[d]);
        ...
        trigger: function (t, n, r, i) {
            ...
            if (
                ...
                3 !== r.nodeType &&
                    8 !== r.nodeType &&
                    !je.test(d + ee.event.triggered) &&
                    (d.indexOf(".") >= 0 && ((h = d.split(".")), (d = h.shift()), h.sort()),
                    (l = d.indexOf(":") < 0 && "on" + d),
                    (t = t[ee.expando] ? t : new ee.Event(d, "object" == typeof t && t)),
                    (t.isTrigger = i ? 2 : 3),
                    (t.namespace = h.join(".")),
                ...
                for (o = 0; (s = p[o++]) && !t.isPropagationStopped(); )
                    (t.type = o > 1 ? u : f.bindType || d),
                        ...
                        c && c.apply(s, n),
                        (c = l && s[l]),
                        c && c.apply && ee.acceptData(s) && ((t.result = c.apply(s, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = d),
                    i ||
                        ...
                        !ee.acceptData(r) ||
                        (l && ee.isFunction(r[d]) && !ee.isWindow(r) && ((a = r[l]), a && (r[l] = null), (ee.event.triggered = d), r[d](), (ee.event.triggered = void 0), a && (r[l] = a))),
                    t.result
                );
            }
        },
        dispatch: function (e) {
            ...
            if (((a[0] = e), (e.delegateTarget = this), !l.preDispatch || !1 !== l.preDispatch.call(this, e))) {
                for (s = ee.event.handlers.call(this, e, u), t = 0; (i = s[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                            ((e.handleObj = o), (e.data = o.data), (r = ((ee.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)), void 0 !== r && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
        ...
        (ee.Event = function (e, t) {
            return this instanceof ee.Event
                ? (e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && e.getPreventDefault && e.getPreventDefault()) ? l : c)) : (this.type = e),
                  t && ee.extend(this, t),
    ...
    (Re.optgroup = Re.option),
        ...
        ee.extend({
            clone: function (e, t, n) {
                ...
                if (!(J.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || ee.isXMLDoc(e))) for (s = v(a), o = v(e), r = 0, i = o.length; i > r; r++) y(o[r], s[r]);
                if (t)
                ...
                for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++)
                    if (((i = e[p]), i || 0 === i))
                        if ("object" === ee.type(i)) ee.merge(f, i.nodeType ? [i] : i);
                            ...
                            for (o = o || c.appendChild(t.createElement("div")), s = (Le.exec(i) || ["", ""])[1].toLowerCase(), a = Re[s] || Re._default, o.innerHTML = a[1] + i.replace(Ae, "<$1></$2>") + a[2], l = a[0]; l--; )
                                o = o.lastChild;
                            ee.merge(f, o.childNodes), (o = c.firstChild), (o.textContent = "");
                        } else f.push(t.createTextNode(i));
                for (c.textContent = "", p = 0; (i = f[p++]); )
                    if ((!r || -1 === ee.inArray(i, r)) && ((u = ee.contains(i.ownerDocument, i)), (o = v(c.appendChild(i), "script")), u && g(o), n)) for (l = 0; (i = o[l++]); ) Fe.test(i.type || "") && n.push(i);
                return c;
            },
            cleanData: function (e) {
                for (var t, n, r, i, o, s, a = ee.event.special, u = 0; void 0 !== (n = e[u]); u++) {
                    if (ee.acceptData(n) && ((o = n[ve.expando]), o && (t = ve.cache[o]))) {
                        if (((r = Object.keys(t.events || {})), r.length)) for (s = 0; void 0 !== (i = r[s]); s++) a[i] ? ee.event.remove(n, i) : ee.removeEvent(n, i, t.handle);
        ...
        ee.fn.extend({
            ...
            remove: function (e, t) {
                for (var n, r = e ? ee.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                    t || 1 !== n.nodeType || ee.cleanData(v(n)), n.parentNode && (t && ee.contains(n.ownerDocument, n) && g(v(n, "script")), n.parentNode.removeChild(n));
                return this;
            },
            empty: function () {
            ...
            domManip: function (e, t) {
                ...
                var n,
                    ...
                    p = e[0],
                    g = ee.isFunction(p);
                if (g || (l > 1 && "string" == typeof p && !J.checkClone && Oe.test(p)))
                ...
                if (l && ((n = ee.buildFragment(e, this[0].ownerDocument, !1, this)), (r = n.firstChild), 1 === n.childNodes.length && (n = r), r)) {
                    ...
                    if (o)
                        for (a = i[i.length - 1].ownerDocument, ee.map(i, h), u = 0; o > u; u++)
                            (s = i[u]), Fe.test(s.type || "") && !ve.access(s, "globalEval") && ee.contains(a, s) && (s.src ? ee._evalUrl && ee._evalUrl(s.src) : ee.globalEval(s.textContent.replace(Me, "")));
                }
                return this;
            },
        }),
            ...
            e.getComputedStyle &&
                ee.extend(J, {
                    ...
                    reliableMarginRight: function () {
                        ...
                        return (
                            (n.style.cssText = a.style.cssText = i),
    ...
    ee.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i,
                    ...
                    u = e.style;
                return (
                    (t = ee.cssProps[a] || (ee.cssProps[a] = C(u, a))),
                    ...
                    void 0 === n
                        ? s && "get" in s && void 0 !== (i = s.get(e, !1, r))
                            ...
                            : u[t]
                        : ((o = typeof n),
                          "string" === o && (i = Ue.exec(n)) && ((n = (i[1] + 1) * i[2] + parseFloat(ee.css(e, t))), (o = "number")),
                          void (
                              null != n &&
                              n == n &&
                              ("number" !== o || ee.cssNumber[a] || (n += "px"),
                              J.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"),
                              (s && "set" in s && void 0 === (n = s.set(e, n, r))) || ((u[t] = ""), (u[t] = n)))
                          ))
                );
            }
        },
        css: function (e, t, n, r) {
            var i,
                ...
                a = ee.camelCase(t);
            return (
                (t = ee.cssProps[a] || (ee.cssProps[a] = C(e.style, a))),
                (s = ee.cssHooks[t] || ee.cssHooks[a]),
                s && "get" in s && (i = s.get(e, !0, n)),
                void 0 === i && (i = w(e, t, r)),
                "normal" === i && t in Ye && (i = Ye[t]),
                "" === n || n ? ((o = parseFloat(i)), !0 === n || ee.isNumeric(o) ? o || 0 : i) : i
            );
        },
    }),
        ee.each(["height", "width"], function (e, t) {
            ee.cssHooks[t] = {
                get: function (e, n, r) {
                    return n
                        ? 0 === e.offsetWidth && Xe.test(ee.css(e, "display"))
                            ? ee.swap(e, Ve, function () {
                                  return E(e, t, r);
                              })
                            : E(e, t, r)
                        : void 0;
        ...
        (ee.cssHooks.marginRight = T(J.reliableMarginRight, function (e, t) {
            return t ? ee.swap(e, { display: "inline-block" }, w, [e, "marginRight"]) : void 0;
        })),
        ...
        (j.prototype = {
            ...
            run: function (e) {
                ...
                return (
                    (this.pos = t = this.options.duration ? ee.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e),
            ...
            "*": [
                function (e, t) {
                    ...
                    if (s && s[3] !== o) {
                        (o = o || s[3]), (i = i || []), (s = +r || 1);
                        do {
                            (a = a || ".5"), (s /= a), ee.style(n.elem, e, s + o);
    ...
    (ee.Animation = ee.extend(O, {
        ...
        (ee.speed = function (e, t, n) {
            var r = e && "object" == typeof e ? ee.extend({}, e) : { complete: n || (!n && t) || (ee.isFunction(e) && e), duration: e, easing: (n && t) || (t && !ee.isFunction(t) && t) };
            return (
                (r.duration = ee.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in ee.fx.speeds ? ee.fx.speeds[r.duration] : ee.fx.speeds._default),
        ...
        ee.each({ slideDown: A("show"), slideUp: A("hide"), slideToggle: A("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
        ...
        ee.extend({
            attr: function (e, t, n) {
                ...
                if (e && 3 !== o && 8 !== o && 2 !== o)
                    return typeof e.getAttribute === ke
                        ? ee.prop(e, t, n)
                        : ((1 === o && ee.isXMLDoc(e)) || ((t = t.toLowerCase()), (r = ee.attrHooks[t] || (ee.expr.match.bool.test(t) ? it : rt))),
                          void 0 === n
                              ? r && "get" in r && null !== (i = r.get(e, t))
                                  ? i
                                  : ((i = ee.find.attr(e, t)), null == i ? void 0 : i)
                              : null !== n
            ...
            removeAttr: function (e, t) {
                var n,
                    ...
                    i = 0,
                    o = t && t.match(he);
                if (o && 1 === e.nodeType) for (; (n = o[i++]); ) (r = ee.propFix[n] || n), ee.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n);
            },
            attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        ee.extend({
            ...
            prop: function (e, t, n) {
                ...
                if (e && 3 !== s && 8 !== s && 2 !== s)
                    return (
                        (o = 1 !== s || !ee.isXMLDoc(e)),
                        o && ((t = ee.propFix[t] || t), (i = ee.propHooks[t])),
            ...
            return "boolean" == typeof t && "string" === n
                ...
                : this.each(
                      ee.isFunction(e)
                          ...
                          : function () {
                                if ("string" === n) for (var t, r = 0, i = ee(this), o = e.match(he) || []; (t = o[r++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                                else (n === ke || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), (this.className = this.className || !1 === e ? "" : ve.get(this, "__className__") || ""));
                            }
                  );
        },
        hasClass: function (e) {
    ...
    ee.fn.extend({
        val: function (e) {
            ...
            return arguments.length
                ...
                : i
                ? ((t = ee.valHooks[i.type] || ee.valHooks[i.nodeName.toLowerCase()]), t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : ((n = i.value), "string" == typeof n ? n.replace(ut, "") : null == n ? "" : n))
                : void 0;
        },
    }),
        ee.extend({
    ...
    (ft = xt.exec(pt.toLowerCase()) || []),
            ...
            ajax: function (e, t) {
                function n(e, t, n, s) {
                    ...
                    2 !== x &&
                        ...
                        (y = W(f, y, w, u)),
                        u
                            ? (f.ifModified && ((b = w.getResponseHeader("Last-Modified")), b && (ee.lastModified[i] = b), (b = w.getResponseHeader("etag")), b && (ee.etag[i] = b)),
                        ...
                        g.fireWith(p, [w, T]),
                        l && (d.trigger("ajaxComplete", [w, f]), --ee.active || ee.event.trigger("ajaxStop")));
                }
                ...
                if (
                    ...
                    (w.success = w.done),
                    (w.error = w.fail),
                    (f.url = ((e || f.url || pt) + "").replace(dt, "").replace(yt, ft[1] + "//")),
                    ...
                    (f.dataTypes = ee
                        ...
                        .match(he) || [""]),
                    null == f.crossDomain &&
                        ((u = xt.exec(f.url.toLowerCase())), (f.crossDomain = !(!u || (u[1] === ft[1] && u[2] === ft[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (ft[3] || ("http:" === ft[1] ? "80" : "443")))))),
                    f.data && f.processData && "string" != typeof f.data && (f.data = ee.param(f.data, f.traditional)),
                    P(bt, f, t, w),
                    2 === x)
                )
                    return w;
                for (c in ((l = f.global),
                l && 0 == ee.active++ && ee.event.trigger("ajaxStart"),
                (f.type = f.type.toUpperCase()),
                (f.hasContent = !vt.test(f.type)),
                (i = f.url),
                f.hasContent || (f.data && ((i = f.url += (ct.test(i) ? "&" : "?") + f.data), delete f.data), !1 === f.cache && (f.url = ht.test(i) ? i.replace(ht, "$1_=" + lt++) : i + (ct.test(i) ? "&" : "?") + "_=" + lt++)),
                f.ifModified && (ee.lastModified[i] && w.setRequestHeader("If-Modified-Since", ee.lastModified[i]), ee.etag[i] && w.setRequestHeader("If-None-Match", ee.etag[i])),
        ...
        ee.each(["get", "post"], function (e, t) {
            ee[t] = function (e, n, r, i) {
                return ee.isFunction(n) && ((i = i || r), (r = n), (n = void 0)), ee.ajax({ url: e, type: t, dataType: i, data: n, success: r });
            };
        }),
                              ...
                              return function () {
                                  t &&
                                      ...
                                      "abort" === e
                                          ...
                                          : r(At[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? { text: o.responseText } : void 0, o.getAllResponseHeaders()));
                              };
                          }),
                              (o.onload = t()),
                              (o.onerror = t("error")),
    ...
    ee.ajaxSetup({
        ...
        ee.ajaxPrefilter("json jsonp", function (t, n, r) {
            var i,
                o,
                s,
                a = !1 !== t.jsonp && (Ht.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Ht.test(t.data) && "data");
            return a || "jsonp" === t.dataTypes[0]
                ? ((i = t.jsonpCallback = ee.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                  a ? (t[a] = t[a].replace(Ht, "$1" + i)) : !1 !== t.jsonp && (t.url += (ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    (ee.fn.load = function (e, t, n) {
        ...
        return (
            ...
            ee.isFunction(t) ? ((n = t), (t = void 0)) : t && "object" == typeof t && (i = "POST"),
            s.length > 0 &&
                ee
    ...
    (ee.offset = {
        ...
        ee.fn.extend({
            offset: function (e) {
                ...
                return o
                    ? ((t = o.documentElement),
                      ee.contains(t, r) ? (typeof r.getBoundingClientRect !== ke && (i = r.getBoundingClientRect()), (n = B(o)), { top: i.top + n.pageYOffset - t.clientTop, left: i.left + n.pageXOffset - t.clientLeft }) : i)
                    : void 0;
            },
            position: function () {
                if (this[0]) {
                    ...
                    return (
                        "fixed" === ee.css(n, "position")
                            ...
                            : ((e = this.offsetParent()), (t = this.offset()), ee.nodeName(e[0], "html") || (r = e.offset()), (r.top += ee.css(e[0], "borderTopWidth", !0)), (r.left += ee.css(e[0], "borderLeftWidth", !0))),
                        { top: t.top - r.top - ee.css(n, "marginTop", !0), left: t.left - r.left - ee.css(n, "marginLeft", !0) }
                    );
                }
            },
        ...
        ee.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (t, n) {
            var r = "pageYOffset" === n;
            ee.fn[t] = function (i) {
                return me(
                    this,
