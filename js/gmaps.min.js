...
(function (e, t) {
    ...
    var t,
        ...
        l = function (e, t) {
            var o,
                n = e.replace(".", "");
            return (o = "jQuery" in this && t ? $("." + n, t)[0] : document.getElementsByClassName(n)[0]), o;
        },
        p = function (e, t) {
            var o;
            e = e.replace("#", "");
            return (o = "jQuery" in window && t ? $("#" + e, t)[0] : document.getElementById(e)), o;
        },
        c = function (e) {
            var t = 0,
                o = 0;
                ...
                o = function (e) {
                    ...
                    var r,
                        ...
                        P = {
                            panControl: L,
                            zoomControl: y,
                            zoomControlOptions: { style: google.maps.ZoomControlStyle[w], position: google.maps.ControlPosition[k] },
                            mapTypeControl: b,
                            scaleControl: _,
                            streetViewControl: M,
                            overviewMapControl: x,
                        };
                    if (("string" == typeof e.el || "string" == typeof e.div ? (u.indexOf("#") > -1 ? (this.el = p(u, e.context)) : (this.el = l.apply(this, [u, e.context]))) : (this.el = u), void 0 === this.el || null === this.el))
                    ...
                    var T = function (e, t) {
                        ...
                        if (p("gmaps_context_menu")) {
                            ...
                            var d = c.apply(this, [s.el]),
                                m = d[0] + t.pixel.x - 15,
                                f = d[1] + t.pixel.y - 15;
                            (a.style.left = m + "px"), (a.style.top = f + "px");
                        }
                    };
                        ...
                        (this.setContextMenu = function (e) {
                            ...
                            for (o in e.options)
                                if (e.options.hasOwnProperty(o)) {
                                    var r = e.options[o];
                                    window.context_menu[s.el.id][e.control][r.name] = { title: r.title, action: r.action };
                                }
                    ...
                    var z = function (t, o) {
                        google.maps.event.addListener(t, o, function (t) {
                            null == t && (t = this), e[o].apply(this, [t]), s.hideContextMenu();
                        });
                    };
    ...
    return (
        (g.prototype.createControl = function (e) {
        ...
        (g.prototype.createMarker = function (e) {
        ...
        (g.prototype.addMarker = function (e) {
            var t;
            ...
            return t.setMap(this.map), this.markerClusterer && this.markerClusterer.addMarker(t), this.markers.push(t), g.fire("marker_added", t, this), t;
        }),
        (g.prototype.addMarkers = function (e) {
            for (var t, o = 0; (t = e[o]); o++) this.addMarker(t);
            return this.markers;
        }),
        (g.prototype.hideInfoWindows = function () {
            for (var e, t = 0; (e = this.markers[t]); t++) e.infoWindow && e.infoWindow.close();
        }),
        (g.prototype.removeMarker = function (e) {
            for (var t = 0; t < this.markers.length; t++)
                if (this.markers[t] === e) {
                    this.markers[t].setMap(null), this.markers.splice(t, 1), this.markerClusterer && this.markerClusterer.removeMarker(e), g.fire("marker_removed", e, this);
                    break;
                }
            return e;
        }),
        (g.prototype.removeMarkers = function (e) {
            var t = [];
            if (void 0 === e) {
                for (var o = 0; o < this.markers.length; o++) {
                    var n = this.markers[o];
                    n.setMap(null), g.fire("marker_removed", n, this);
                }
                ...
                for (o = 0; o < e.length; o++) {
                    ...
                    if (r > -1) {
                        n = this.markers[r];
                        n.setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(n), g.fire("marker_removed", n, this);
                    }
                }
        ...
        (g.prototype.drawOverlay = function (e) {
        ...
        (g.prototype.removeOverlay = function (e) {
        ...
        (g.prototype.drawPolyline = function (e) {
            var t = [],
                o = e.path;
            if (o.length)
                if (void 0 === o[0][0]) t = o;
            ...
            return this.polylines.push(s), g.fire("polyline_added", s, this), s;
        }),
        (g.prototype.removePolyline = function (e) {
            for (var t = 0; t < this.polylines.length; t++)
                if (this.polylines[t] === e) {
                    this.polylines[t].setMap(null), this.polylines.splice(t, 1), g.fire("polyline_removed", e, this);
                    break;
                }
        }),
        (g.prototype.removePolylines = function () {
            for (var e, t = 0; (e = this.polylines[t]); t++) e.setMap(null);
            this.polylines = [];
        }),
        (g.prototype.drawCircle = function (e) {
            (e = n({ map: this.map, center: new google.maps.LatLng(e.lat, e.lng) }, e)), delete e.lat, delete e.lng;
            for (var t = new google.maps.Circle(e), o = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], r = 0; r < o.length; r++)
                (function (t, o) {
                    e[o] &&
                        google.maps.event.addListener(t, o, function (t) {
                            e[o].apply(this, [t]);
        ...
        (g.prototype.drawRectangle = function (e) {
            ...
            e.bounds = t;
            for (var o = new google.maps.Rectangle(e), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < r.length; i++)
                (function (t, o) {
                    e[o] &&
                        google.maps.event.addListener(t, o, function (t) {
                            e[o].apply(this, [t]);
        ...
        (g.prototype.drawPolygon = function (e) {
            var t = !1;
            ...
            return this.polygons.push(o), g.fire("polygon_added", o, this), o;
        }),
        (g.prototype.removePolygon = function (e) {
            for (var t = 0; t < this.polygons.length; t++)
                if (this.polygons[t] === e) {
                    this.polygons[t].setMap(null), this.polygons.splice(t, 1), g.fire("polygon_removed", e, this);
                    break;
                }
        }),
        (g.prototype.removePolygons = function () {
            for (var e, t = 0; (e = this.polygons[t]); t++) e.setMap(null);
            this.polygons = [];
        }),
        (g.prototype.getFromFusionTables = function (e) {
            var t = e.events;
            delete e.events;
            var o = e,
        ...
        (g.prototype.loadFromFusionTables = function (e) {
            var t = this.getFromFusionTables(e);
            return t.setMap(this.map), t;
        }),
        (g.prototype.getFromKML = function (e) {
            var t = e.url,
                o = e.events;
        ...
        (g.prototype.loadFromKML = function (e) {
            var t = this.getFromKML(e);
            return t.setMap(this.map), t;
        }),
        (g.prototype.addLayer = function (e, t) {
            var o;
            switch (((t = t || {}), e)) {
                case "weather":
        ...
        (g.prototype.removeLayer = function (e) {
        ...
        (g.prototype.getRoutes = function (e) {
            switch (e.travelMode) {
                case "bicycling":
            ...
            var r = { avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: [] },
                i = n(r, e);
            ...
            a.route(i, function (t, o) {
                if (o === google.maps.DirectionsStatus.OK) {
                    for (var n in t.routes) t.routes.hasOwnProperty(n) && s.push(t.routes[n]);
                    e.callback && e.callback(s, t, o);
                } else e.error && e.error(t, o);
            });
        }),
        (g.prototype.removeRoutes = function () {
            this.routes.length = 0;
        }),
        (g.prototype.getElevations = function (e) {
            (e = n({ locations: [], path: !1, samples: 256 }, e)), e.locations.length > 0 && e.locations[0].length > 0 && (e.locations = i(r([e.locations], a, !1)));
            var t = e.callback;
            delete e.callback;
            var o = new google.maps.ElevationService();
            if (e.path) {
                var s = { path: e.locations, samples: e.samples };
                o.getElevationAlongPath(s, function (e, o) {
        ...
        (g.prototype.cleanRoute = g.prototype.removePolylines),
        (g.prototype.renderRoute = function (e, t) {
            var o,
                r = "string" == typeof t.panel ? document.getElementById(t.panel.replace("#", "")) : t.panel;
            (t.panel = r),
                (t = n({ map: this.map }, t)),
        ...
        (g.prototype.drawRoute = function (e) {
            var t = this;
            this.getRoutes({
                origin: e.origin,
                destination: e.destination,
        ...
        (g.prototype.travelRoute = function (e) {
        ...
        (g.prototype.drawSteppedRoute = function (e) {
            var t = this;
            if (e.origin && e.destination)
                this.getRoutes({
                    origin: e.origin,
        ...
        (g.Route.prototype.getRoute = function (t) {
            var o = this;
            this.map.getRoutes({
                origin: this.origin,
        ...
        (g.Route.prototype.back = function () {
        ...
        (g.Route.prototype.forward = function () {
        ...
        (g.prototype.checkGeofence = function (e, t, o) {
            return o.containsLatLng(new google.maps.LatLng(e, t));
        }),
        (g.prototype.checkMarkerGeofence = function (e, t) {
            if (e.fences)
        ...
        (g.prototype.toImage = function (e) {
            e = e || {};
            var t = {};
            ...
            return g.staticMapURL(t);
        }),
        (g.staticMapURL = function (e) {
            function t(e, t) {
            ...
            if (i)
                for (var h, u, d = 0; (o = i[d]); d++) {
                    ...
                    delete o.lng,
                    o))
                        o.hasOwnProperty(g) && h.push(g + ":" + o[g]);
        ...
        (g.prototype.addMapType = function (e, t) {
        ...
        (g.prototype.addOverlayMapType = function (e) {
        ...
        (g.prototype.removeOverlayMapType = function (e) {
            this.map.overlayMapTypes.removeAt(e);
        }),
        (g.prototype.addStyle = function (e) {
        ...
        (g.prototype.createPanorama = function (e) {
            return (e.hasOwnProperty("lat") && e.hasOwnProperty("lng")) || ((e.lat = this.getCenter().lat()), (e.lng = this.getCenter().lng())), (this.panorama = g.createPanorama(e)), this.map.setStreetView(this.panorama), this.panorama;
        }),
        (g.createPanorama = function (e) {
        ...
        (g.prototype.on = function (e, t) {
            return g.on(e, this, t);
        }),
        (g.prototype.off = function (e) {
            g.off(e, this);
        }),
        (g.prototype.once = function (e, t) {
            return g.once(e, this, t);
        }),
        (g.custom_events = ["marker_added", "marker_removed", "polyline_added", "polyline_removed", "polygon_added", "polygon_removed", "geolocated", "geolocation_failed"]),
        (g.on = function (e, t, o) {
            if (-1 == g.custom_events.indexOf(e)) return t instanceof g && (t = t.map), google.maps.event.addListener(t, e, o);
            var n = { handler: o, eventName: e };
            return (t.registered_events[e] = t.registered_events[e] || []), t.registered_events[e].push(n), n;
        }),
        (g.off = function (e, t) {
            -1 == g.custom_events.indexOf(e) ? (t instanceof g && (t = t.map), google.maps.event.clearListeners(t, e)) : (t.registered_events[e] = []);
        }),
        (g.once = function (e, t, o) {
            if (-1 == g.custom_events.indexOf(e)) return t instanceof g && (t = t.map), google.maps.event.addListenerOnce(t, e, o);
        }),
        (g.fire = function (e, t, o) {
            if (-1 == g.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2));
        ...
        "object" == typeof window.google &&
            ...
            google.maps.Polygon.prototype.containsLatLng ||
                (google.maps.Polygon.prototype.containsLatLng = function (e) {
                    ...
                    for (var o = !1, n = this.getPaths().getLength(), r = 0; r < n; r++)
                        for (var i = this.getPaths().getAt(r), s = i.getLength(), a = s - 1, l = 0; l < s; l++) {
                            var p = i.getAt(l),
                                c = i.getAt(a);
