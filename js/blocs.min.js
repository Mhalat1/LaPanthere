        ...
        if (i.parent().hasClass("nav-special"))
            if ((t.stopPropagation(), $(this).hasClass("selected-nav")))
                ...
                ($(".content-tint").length = -1) && $("body").append('<div class="content-tint"></div>'),
                    a.insertBefore(".page-container").wrap('<div class="blocsapp-special-menu ' + o + '"><blocsnav class="' + l + '">'),
            ...
            $(this)
                ...
                .each(function (t) {
                    (fillPadding = 2 * parseInt($(this).css("padding-top"))),
                        e.hasClass("bloc-group") ? (fillBodyHeight = fillPadding + $(this).outerHeight() + 50) : (fillBodyHeight = fillBodyHeight + fillPadding + $(this).outerHeight() + 50);
                }),
...
function stickyNavToggle() {
    ...
    $(window).scrollTop() > t
        ? ($(".sticky-nav").addClass(e), "sticky" == e && $(".page-container").css("padding-top", $(".sticky-nav").height()))
        : ($(".sticky-nav").removeClass(e).removeAttr("style"), $(".page-container").removeAttr("style"));
}
function hideAll() {
...
function setUpLightBox() {
    window.targetLightbox,
        $(document)
            .on("click", "[data-lightbox]", function (t) {
                ...
                $("body").append(s),
                    ...
                    ".mp4" == e.substring(e.length - 4) ? ($("#lightbox-image, .lightbox-caption").hide(), $("#lightbox-video-container").show()) : ($("#lightbox-image,.lightbox-caption").show(), $("#lightbox-video-container").hide()),
        ...
        $(document).on("click", ".next-lightbox, .prev-lightbox", function (t) {
            ...
            targetLightbox.attr("data-gallery-id") && ((e = targetLightbox.attr("data-gallery-id")), (i = $('a[data-gallery-id="' + e + '"]').index(targetLightbox)), (a = $('a[data-gallery-id="' + e + '"]').eq(i + 1))),
                $(this).hasClass("prev-lightbox") && ((a = $('a[data-gallery-id="' + e + '"]').eq(i - 1)), "no-gallery-set" == e && (a = $("a[data-lightbox]").eq(i - 1)));
            var o = a.attr("data-lightbox");
            if (".mp4" == o.substring(o.length - 4)) {
                var l = "";
                1 == a.attr("data-autoplay") && (l = "autoplay"),
            ...
            (targetLightbox = a),
                ...
                "no-gallery-set" == e
                    ? ($("a[data-lightbox]").index(a) != $("a[data-lightbox]").length - 1 && $(".next-lightbox").show(), $("a[data-lightbox]").index(a) > 0 && $(".prev-lightbox").show())
                    : ($('a[data-gallery-id="' + e + '"]').index(a) != $('a[data-gallery-id="' + e + '"]').length - 1 && $(".next-lightbox").show(), $('a[data-gallery-id="' + e + '"]').index(a) > 0 && $(".prev-lightbox").show());
        });
}
...
$(document).ready(function () {
    $("#scroll-hero").click(function (t) {
        t.preventDefault(), $("html,body").animate({ scrollTop: $("#scroll-hero").closest(".bloc").height() }, "slow");
    }),
        extraNavFuncs(),
        setUpSpecialNavs(),
        setUpDropdownSubs(),
